...
const App = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Agregar Cliente" onPress={() => setModalVisible(true)} color="#961FF9" />
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            />
            {/*campo para el registro de la cantidad de personas */}
            <TextInput
              style={styles.input}
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.clienteNombre}>Cantidad de Personas:{item.cantidad}</Text>
            <Text style={styles.clienteFecha}>
              Fecha de Reserva: {item.fechaReserva.toDateString()}
            </Text>
            <Button title="Eliminar" onPress={() => eliminarCliente(item.id)} color="#BF8CF9"/>
          </TouchableOpacity>
        )}
